...
fun Properties.requireProperty(propertyName: String) = this.getProperty(propertyName)?:
        throw NullPointerException("no required property named '${propertyName}' is found")
